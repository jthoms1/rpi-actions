...
```
.claude/skills/
  research-codebase/SKILL.md   # /research-codebase — defines the research methodology
  create-plan/SKILL.md         # /create-plan — defines the planning methodology
  implement-plan/SKILL.md      # /implement-plan — defines the implementation methodology
...
- The three **skills** define the methodology for each pipeline stage. The workflows reference these skills via CLAUDE.md instructions in the user's repo — they don't duplicate the skill logic.
